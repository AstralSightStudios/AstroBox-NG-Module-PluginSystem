# AstroBox-NG-Module-PluginSystem

此项目为AstroBox插件模块，用于为astrobox提供插件功能，此库使用 AGPL 3.0 授权

This project is an AstroBox plugin module, used to provide plugin functionality for AstroBox. This library is licensed under AGPL 3.0.
